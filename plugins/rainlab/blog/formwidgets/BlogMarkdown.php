...
use Response;
use Validator;
use RainLab\Blog\Models\Course as CourseModel;
...
/**
 * Special markdown editor for the Create/Edit Course form.
 *
...
class BlogMarkdown extends MarkdownEditor
{
    ...
    public function onRefresh()
    {
        ...
        $previewHtml = CourseModel::formatHtml($content, true);
    ...
    protected function checkUploadCourseback()
    {
