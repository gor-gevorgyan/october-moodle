...
class Category extends Model
{
    ...
    public $belongsToMany = [
        'courses' => ['RainLab\Blog\Models\Course',
            'table' => 'rainlab_blog_courses_categories',
            'order' => 'published_at desc',
            'scope' => 'isPublished'
        ],
        'courses_count' => ['RainLab\Blog\Models\Course',
            'table' => 'rainlab_blog_courses_categories',
            'scope' => 'isPublished',
            'count' => true
        ]
    ...
    {
        return optional($this->courses_count->first())->count ?? 0;
    }

    /**
     * Count courses in this and nested categories
     * @return int
     */
    public function getNestedCourseCount()
    {
        return $this->course_count + $this->children->sum(function ($category) {
            return $category->getNestedCourseCount();
        });
    }
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                if (!$page->hasComponent('blogCourses')) {
                    continue;
                }
                 ...
                 */
                $properties = $page->getComponentProperties('blogCourses');
